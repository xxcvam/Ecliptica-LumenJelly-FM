...
> = {
  ...
  'Robot Teacup': { visualId: 'model', params: { src: '/models/default/teacup.glb', fallback: true } },
  ...
  'Slow Whale': { visualId: 'model', params: { src: '/models/default/whale.glb', fallback: true } },
